            ...
            if (step + 1) % args.gradient_accumulation_steps == 0 or (
                ...
                if global_step % 500 == 0:
                    ...
                    if test_f1 > max_test_f1:
                        ...
                        raw_output_dir = '/export/home/Dataset/BERT_pretrained_mine/paragraph_entail/hypothesis_only_summary/'
...
if __name__ == "__main__":
    ...
    '''
    '''
    CUDA_VISIBLE_DEVICES=0,1,2,3 python -u train_entail_hypothesis_only.py --model_type roberta --model_name_or_path roberta-large --task_name rte > log.hypo.only.summary.20200416.txt 2>&1
    '''
