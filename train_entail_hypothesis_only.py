...
if __name__ == "__main__":
    ...
    '''
    '''
    CUDA_VISIBLE_DEVICES=5 python -u train_entail_hypothesis_only.py --model_type roberta --model_name_or_path roberta-large --task_name rte > log.hypo.only.ANLI.20200416.txt 2>&1
    '''
