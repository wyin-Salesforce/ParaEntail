...
def main():
    ...
    model.load_state_dict(torch.load('/export/home/Dataset/BERT_pretrained_mine/paragraph_entail/2021/docNLI_Longformer_epoch_1.pt', map_location=device))
...
CUDA_VISIBLE_DEVICES=4 python -u test_on_docNLI_Longformer.py --task_name rte --do_train --do_lower_case --data_label DUC --num_train_epochs 20 --train_batch_size 4 --eval_batch_size 80 --learning_rate 1e-6 --max_seq_length 1024 --seed 42
