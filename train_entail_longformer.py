...
def main():
    ...
    parser.add_argument(
        "--num_train_epochs", default=50.0, type=float, help="Total number of training epochs to perform.",
    )
    parser.add_argument(
        "--max_steps",
        default=-1,
...
if __name__ == "__main__":
    ...
    '''
    to install (only need install json-lines to run the "test_longformer_sentenceNLI.py")
